...
APPS="libtxc_dxtn.i686 unrar p7zip p7zip-plugins cabextract nano lynx libXp usb_modeswitch pdfjam djvulibre djvulibre-mozplugin evince-djvu hdparm faad2 gnupg2 mmv sane-backends sane-backends-libs sane-frontends libsane-hpaio hplip icoutils chntpw dbus-x11 xdotool exfat-utils fuse-exfat kernel-tools i7z cpulimit bchunk xmedcon samba samba-common samba-client libsmbclient system-config-samba samba-winbind smartmontools hddtemp htop powertop meld extundelete sppedtest-cli ninvaders bsd-games"

GNOME_APPS="subtitleeditor transmission firewall-config dcraw unoconv clamtk youtube-dl libva-intel-driver libva-vdpau-driver libva-utils ffmpeg ImageMagick xine-lib-extras-freeworld gstreamer1 gstreamer1-plugins-good gstreamer1-plugins-bad-freeworld gstreamer1-plugins-ugly gstreamer1-libav gstreamer-plugins-ugly gstreamer-plugins-farsight gstreamer-ffmpeg gstreamer-plugins-bad gstreamer-plugins-schroedinger libtheora libvorbis libogg dirac dirac-libs schroedinger firefox java-openjdk icedtea-web gnome-music gnome-maps gnome-photos gnome-documents gimp xsane-gimp xsane gnome-weather gnome-calendar bijiben xournal gnome-logs gnome-sound-recorder gnome-books gnome-todo audacity-freeworld polari brasero gnome-boxes deja-dup eog totem pitivi openshot rhythmbox seahorse nautilus-image-converter gnome-terminal-nautilus gparted simple-scan gimagereader-gtk tesseract tesseract-langpack-ita gnome-tweak-tool easytag epiphany gscan2pdf gnome-power-manager gnome-multi-writer pdfshuffler gnome-battery-bench vino vinagre gthumb liveusb-creator stellarium vlc gpredict transmageddon pavucontrol dosbox inkscape libreoffice-calc libreoffice-core libreoffice-draw libreoffice-graphicfilter libreoffice-impress libreoffice-math libreoffice-opensymbol-fonts libreoffice-pdfimport libreoffice-ure libreoffice-writer libreoffice-xsltfilter libreoffice-langpack-it impressive x264 filezilla vorbis-tools soundconverter tracker-preferences gedit-plugins glabels gitg"
